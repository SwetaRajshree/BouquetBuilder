          ...
          <div className="relative overflow-hidden rounded-lg p-10 md:p-14 shadow-soft-m cursor-pointer group"
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              <div className="flex-shrink-0 relative">
                ...
                {['💝','💖','💗','💓'].map((h, i) => (
                  <span key={i} className="absolute text-lg pointer-events-none select-none"
                    style={{ top: `${-10 - i * 18}px`, left: `${30 + (i % 2 === 0 ? -14 : 14)}px`, animation: `petalFloat ${2.5 + i * 0.4}s ease-in-out ${i * 0.3}s infinite`, opacity: 0.85 }}>{h}</span>
                ))}
                {reviewCount > 0 && (
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <h2 className="font-playfair font-bold text-[clamp(1.5rem,3vw,2.1rem)] text-roseDD mb-3">Your Love 💝</h2>
                ...
                <button onClick={e => { e.stopPropagation(); navigate('/your-love'); }}
            ...
            <style>{`@keyframes loveShift { 0%,100%{background-position:0% 50%;} 50%{background-position:100% 50%;} }`}</style>
          </div>
        </div>
      </section>
