...
const GlobalStyles = () => (
  <style>{`
    ...
    .hc-root{font-family:'Outfit',sans-serif;background:#0a0a0f;color:#fff;overflow-x:hidden}
    .hc-root ::-webkit-scrollbar{width:6px}
    .hc-root ::-webkit-scrollbar-track{background:#111}
    .hc-root ::-webkit-scrollbar-thumb{background:#f59e0b;border-radius:3px}
    @keyframes hc-fadeUp{from{opacity:0;transform:translateY(30px)}to{opacity:1;transform:translateY(0)}}
    @keyframes hc-fadeIn{from{opacity:0}to{opacity:1}}
    @keyframes hc-pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.05)}}
    @keyframes hc-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}
    @keyframes hc-shimmer{0%{background-position:-200% center}100%{background-position:200% center}}
    @keyframes hc-float{0%,100%{transform:translateY(0px)}50%{transform:translateY(-12px)}}
    @keyframes hc-glow{0%,100%{box-shadow:0 0 20px rgba(245,158,11,0.3)}50%{box-shadow:0 0 40px rgba(245,158,11,0.6)}}
    @keyframes hc-slideDown{from{opacity:0;transform:translateY(-10px)}to{opacity:1;transform:translateY(0)}}
    @keyframes hc-countUp{from{opacity:0;transform:scale(0.5)}to{opacity:1;transform:scale(1)}}
    @keyframes hc-bounce{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)}}
    @keyframes hc-heartbeat{0%,100%{transform:scale(1)}14%{transform:scale(1.3)}28%{transform:scale(1)}42%{transform:scale(1.3)}70%{transform:scale(1)}}
    @keyframes hc-toastIn{from{transform:translateX(120%);opacity:0}to{transform:translateX(0);opacity:1}}
    @keyframes hc-modalIn{from{opacity:0;transform:scale(0.92) translateY(20px)}to{opacity:1;transform:scale(1) translateY(0)}}
    .hc-root .btn-glow:hover{animation:hc-glow 1.5s infinite}
    .hc-root .float-anim{animation:hc-float 3s ease-in-out infinite}
    .hc-root .fade-up{animation:hc-fadeUp 0.6s ease both}
    .hc-root .product-card:hover .card-img img{transform:scale(1.08)}
    .hc-root .nav-link{position:relative}
    .hc-root .nav-link::after{content:'';position:absolute;bottom:-2px;left:0;width:0;height:2px;background:#f59e0b;transition:width .3s}
    .hc-root .nav-link:hover::after{width:100%}
    .hc-root input:focus,.hc-root select:focus,.hc-root textarea:focus{outline:none;border-color:#f59e0b!important;box-shadow:0 0 0 3px rgba(245,158,11,0.15)!important}
    .hc-root .img-fade{transition:opacity 0.4s ease}
  `}</style>
);
...
function ProductImage({id, size="100%", height=200, radius=0, fallbackEmoji="🎨"}){
  ...
  return (
    <div style={{width:size,height,overflow:"hidden",borderRadius:radius,position:"relative",background:"#1a1025"}}>
      {!loaded && <div style={{position:"absolute",inset:0,background:"linear-gradient(90deg,#1a1025 25%,#2a1a35 50%,#1a1025 75%)",backgroundSize:"200% 100%",animation:"hc-shimmer 1.5s infinite"}}/>}
    ...
    <div style={{position:"fixed",bottom:24,right:24,zIndex:9999,display:"flex",flexDirection:"column",gap:10}}>
      {toasts.map(t=>(
        <div key={t.id} style={{
          ...
          animation:"hc-toastIn 0.4s ease both",cursor:"pointer",
  ...
  return(
    <div style={{position:"relative",height:"92vh",minHeight:560,overflow:"hidden",background:s.bg,transition:"background 0.8s ease"}}>
      ...
      <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",textAlign:"center",padding:"0 20px",opacity:transitioning?0:1,transform:transitioning?"translateY(20px)":"translateY(0)",transition:"all 0.4s ease"}}>
        <div style={{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(255,255,255,0.08)",backdropFilter:"blur(10px)",border:`1px solid ${s.accent}44`,padding:"8px 20px",borderRadius:40,fontSize:13,color:s.accent,fontWeight:600,marginBottom:28,animation:"hc-fadeUp 0.6s ease both"}}>
          <span style={{animation:"hc-bounce 1s infinite"}}>{s.emoji}</span>CraftBaazar — India's Artisan Marketplace
        </div>
        <h1 style={{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:"clamp(2.5rem,7vw,5.5rem)",lineHeight:1.1,marginBottom:16,animation:"hc-fadeUp 0.6s 0.1s ease both",opacity:0,animationFillMode:"both"}}>
        ...
        <p style={{fontSize:"clamp(1rem,2vw,1.25rem)",color:"rgba(255,255,255,0.65)",maxWidth:560,lineHeight:1.7,marginBottom:40,animation:"hc-fadeUp 0.6s 0.2s ease both",opacity:0,animationFillMode:"both"}}>{s.sub}</p>
        <div style={{display:"flex",gap:16,flexWrap:"wrap",justifyContent:"center",animation:"hc-fadeUp 0.6s 0.3s ease both",opacity:0,animationFillMode:"both"}}>
        ...
        <div style={{display:"flex",gap:40,marginTop:60,animation:"hc-fadeUp 0.6s 0.4s ease both",opacity:0,animationFillMode:"both"}}>
  ...
  return(
    ...
    onMouseLeave={e=>{e.currentTarget.style.borderColor="#1e1e2e";e.currentTarget.style.transform="translateY(0)";e.currentTarget.style.boxShadow="none";}}>
      <div className="card-img" style={{height:200,position:"relative",overflow:"hidden"}}>
        ...
        <button onClick={e=>{e.stopPropagation();onToggleWish(product.id);}} style={{position:"absolute",top:8,right:8,width:32,height:32,borderRadius:"50%",background:"rgba(0,0,0,0.5)",backdropFilter:"blur(10px)",border:"none",cursor:"pointer",fontSize:16,display:"flex",alignItems:"center",justifyContent:"center",animation:wished?"hc-heartbeat 0.6s ease":"none",transition:"transform .2s"}}>
          {wished?"❤️":"🤍"}
        </button>
      </div>
...
function ProductDetail({product,onClose,onAddToCart,onToggleWish,wished,toast}){
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:5000,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"}} onClick={e=>{if(e.target===e.currentTarget)onClose();}}>
      ...
      <div style={{position:"relative",background:"#111117",borderRadius:28,border:"1px solid #1e1e2e",width:"100%",maxWidth:900,maxHeight:"90vh",overflow:"auto",animation:"hc-modalIn 0.35s ease both",boxShadow:"0 40px 100px rgba(0,0,0,0.8)"}}>
...
function CheckoutModal({cart,onClose,onSuccess,toast}){
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:6000,display:"flex",alignItems:"center",justifyContent:"center",padding:20}} onClick={e=>{if(e.target===e.currentTarget&&step!==3)onClose();}}>
      <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.85)",backdropFilter:"blur(10px)"}}/>
      <div style={{position:"relative",background:"#111117",borderRadius:28,border:"1px solid #1e1e2e",width:"100%",maxWidth:560,animation:"hc-modalIn 0.35s ease both",boxShadow:"0 40px 100px rgba(0,0,0,0.8)"}}>
          ...
          <div style={{padding:"0 32px 32px"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:12}}>
              ...
              <button onClick={handleSubmit} disabled={loading} style={{padding:"14px",borderRadius:14,border:"none",background:loading?"#374151":"linear-gradient(135deg,#f59e0b,#d97706)",color:"#fff",fontWeight:700,fontSize:15,cursor:loading?"not-allowed":"pointer",fontFamily:"'Outfit',sans-serif",display:"flex",alignItems:"center",justifyContent:"center",gap:10}}>
                {loading?<><span style={{animation:"hc-spin 1s linear infinite",display:"inline-block"}}>⟳</span> Processing...</>:"Place Order →"}
              </button>
            </div>
          </div>
        )}
        ...
        {step===3&&(
          <div style={{padding:48,textAlign:"center"}}>
            <div style={{fontSize:72,marginBottom:16,animation:"hc-bounce 1s infinite"}}>🎉</div>
    ...
    <nav style={{position:"sticky",top:0,zIndex:1000,background:scrolled?"rgba(10,10,15,0.95)":"rgba(10,10,15,0.8)",backdropFilter:"blur(20px)",borderBottom:"1px solid rgba(255,255,255,0.06)",transition:"all .3s"}}>
      <div style={{maxWidth:1280,margin:"0 auto",padding:"0 24px",display:"flex",alignItems:"center",gap:16,height:68}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:4}}>
          ...
          onMouseEnter={e=>e.currentTarget.style.transform="scale(1.15)"}
          onMouseLeave={e=>e.currentTarget.style.transform="scale(1)"}>
            🛒{cartCount>0&&<span style={{position:"absolute",top:2,right:2,background:"#f59e0b",color:"#000",borderRadius:"50%",width:16,height:16,fontSize:10,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:700,animation:"hc-countUp .3s ease"}}>{cartCount}</span>}
          </button>
          {user?(
      ...
      <section style={{padding:"80px 24px"}}>
        <div style={{maxWidth:1100,margin:"0 auto"}}>
          <div style={{borderRadius:28,padding:"64px 56px",background:"linear-gradient(135deg,#1a0533,#3b0764)",border:"1px solid rgba(168,85,247,0.3)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:32,flexWrap:"wrap",boxShadow:"0 0 80px rgba(168,85,247,0.15)"}}>
            ...
            <div style={{fontSize:120,animation:"hc-float 4s ease-in-out infinite"}}>🧑‍🎨</div>
          </div>
        </div>
      </section>
    </div>
...
export default function HandcraftPage(){
  ...
  const handleSearch=(query)=>{
    ...
    if(query.trim()) setPage("shop");
  };

  const handleOrderSuccess=()=>{
    setCart([]);
    setPage("profile");
    addToast("Order placed! View in your profile 🎉","success");
  };
  ...
  return(
    <div className="hc-root">
      ...
      <Navbar
        ...
        onSearch={handleSearch} searchQuery={globalSearch}
      />
      {page==="home"&&<HomePage setPage={setPage} setCart={setCart} wishlist={wishlist} toggleWish={toggleWish} toast={addToast} onOpenDetail={openDetail}/>}
      ...
      {page==="cart"&&<CartPage cart={cart} setCart={setCart} setPage={setPage} toast={addToast} setShowCheckout={setShowCheckout}/>}
      {page==="wishlist"&&<WishlistPage wishlist={wishlist} toggleWish={toggleWish} setCart={setCart} setPage={setPage} toast={addToast} onOpenDetail={openDetail}/>}
      {page==="login"&&<LoginPage setUser={setUser} setPage={setPage} toast={addToast}/>}
      {page==="seller"&&<SellerPage user={user} setPage={setPage} toast={addToast}/>}
      {page==="profile"&&<ProfilePage user={user} setUser={setUser} setPage={setPage} cart={cart} wishlist={wishlist} toast={addToast}/>}
