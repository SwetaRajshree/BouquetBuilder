...
const styles = `
  ...
  .hc-root { scroll-behavior: smooth; }
  ...
  .hc-root .nav-links { display: flex; align-items: center; gap: 2px; list-style: none; }
  .hc-root .nav-links a {
    padding: 6px 14px; border-radius: 8px;
    font-size: 0.875rem; font-weight: 500;
    color: var(--text); text-decoration: none; transition: var(--transition);
  }
  .hc-root .nav-links a:hover { background: var(--rose-light); color: var(--rose-deep); }
  .hc-root .nav-right { display: flex; align-items: center; gap: 12px; }
  .hc-root .nav-search {
  ...
  .hc-root .nav-search:focus-within { border-color: var(--rose); background: white; }
  .hc-root .nav-search input {
    border: none; background: transparent; outline: none;
    font-family: var(--font-body); font-size: 0.85rem; color: var(--text); width: 150px;
  }
  .hc-root .nav-search input::placeholder { color: var(--text-muted); }
  .hc-root .btn-icon {
  ...
  .hc-root .btn-icon:hover { background: var(--rose-light); border-color: var(--rose); }
  .hc-root .cart-badge {
  ...
  .hc-root .btn-artist:hover { background: var(--rose-deep); transform: translateY(-1px); animation: none; }
  @keyframes softPulse {
  ...
  .hc-root .hero {
    position: relative;
    height: calc(100vh - 62px); min-height: 600px; overflow: hidden;
  }
  .hc-root .hero-slide {
  ...
  .hc-root .hero-slide.active { opacity: 1; }
  .hc-root .hero-bg {
    position: absolute; inset: -5%;
    transition: transform 9s ease; transform: scale(1.08);
  }
  .hc-root .hero-slide.active .hero-bg { transform: scale(1); }
  .hc-root .hero-bg-1 { background: linear-gradient(135deg, #6b2d45 0%, #a85570 40%, #c9748a 70%, #e8b4c0 100%); }
  .hc-root .hero-bg-2 { background: linear-gradient(135deg, #7a5060 0%, #c8915a 50%, #e8c4a0 100%); }
  .hc-root .hero-bg-3 { background: linear-gradient(135deg, #4a2535 0%, #9b7b8a 50%, #c9748a 100%); }
  .hc-root .hero-overlay {
    position: absolute; inset: 0;
    background: linear-gradient(90deg, rgba(30,10,20,0.55) 0%, rgba(30,10,20,0.1) 65%, transparent 100%);
  }
  .hc-root .hero-petals { position: absolute; inset: 0; pointer-events: none; overflow: hidden; }
  .hc-root .petal {
  ...
  .hc-root .hero-content { position: relative; z-index: 2; max-width: 620px; color: white; }
  .hc-root .hero-tag {
  ...
  .hc-root .hero-slide.active .hero-tag { opacity: 1; transform: translateY(0); }
  .hc-root .hero-title {
  ...
  .hc-root .hero-slide.active .hero-title { opacity: 1; transform: translateX(0); }
  .hc-root .hero-sub {
    font-size: 1.05rem; color: rgba(255,255,255,0.82); margin-bottom: 36px; line-height: 1.7;
    opacity: 0; transform: translateX(-24px);
    transition: opacity 0.7s ease 0.4s, transform 0.7s ease 0.4s;
  }
  .hc-root .hero-slide.active .hero-sub { opacity: 1; transform: translateX(0); }
  .hc-root .hero-btns {
    display: flex; gap: 14px; flex-wrap: wrap;
    opacity: 0; transform: translateY(16px);
    transition: opacity 0.6s ease 0.55s, transform 0.6s ease 0.55s;
  }
  .hc-root .hero-slide.active .hero-btns { opacity: 1; transform: translateY(0); }
  .hc-root .btn-primary {
  ...
  .hc-root .btn-primary:hover { background: var(--rose-deep); transform: translateY(-2px); box-shadow: 0 8px 24px rgba(168,85,112,0.4); }
  .hc-root .btn-outline-white {
    padding: 13px 28px; border-radius: 12px;
  ...
  .hc-root .btn-outline-white:hover { background: rgba(255,255,255,0.12); border-color: white; }
  .hc-root .hero-dots {
  ...
  .hc-root .hero-dot.active { width: 28px; background: white; }

  /* ── SECTIONS ── */
  .hc-root .section { padding: 96px 60px; }
  .hc-root .section-inner { max-width: 1280px; margin: 0 auto; }
  .hc-root .section-header { display: flex; align-items: flex-end; justify-content: space-between; margin-bottom: 48px; }
  .hc-root .section-label {
    font-size: 0.72rem; font-weight: 600; letter-spacing: 0.16em;
    text-transform: uppercase; color: var(--rose); margin-bottom: 8px;
  }
  .hc-root .section-title {
  ...
  .hc-root .btn-explore:hover { background: var(--rose-light); border-color: var(--rose); }

  /* fade-up */
  .hc-root .fade-up { opacity: 0; transform: translateY(36px); transition: opacity 0.7s ease, transform 0.7s ease; }
  .hc-root .fade-up.visible { opacity: 1; transform: translateY(0); }
  .hc-root .fade-up-delay-1 { transition-delay: 0.1s; }
  .hc-root .fade-up-delay-2 { transition-delay: 0.2s; }
  .hc-root .fade-up-delay-3 { transition-delay: 0.3s; }

  /* ── OUR STORY SECTION ── */
  .hc-root .join-section {
    padding: 96px 60px;
    background: linear-gradient(135deg, #fdf0f3 0%, #faeaef 100%);
    position: relative; overflow: hidden;
  }
  .hc-root .join-section::before {
    content: ''; position: absolute; top: -80px; right: -80px;
    width: 320px; height: 320px; border-radius: 50%;
    background: radial-gradient(circle, rgba(201,116,138,0.08), transparent);
    pointer-events: none;
  }
  .hc-root .story-heading {
    font-family: var(--font-display); font-size: clamp(1.9rem, 3vw, 2.9rem);
  ...
  .hc-root .join-card:hover { transform: translateY(-6px); box-shadow: var(--shadow-hover); }
  .hc-root .join-icon {
  ...
  .hc-root .join-card:hover .join-icon { background: var(--rose); transform: scale(1.08) rotate(-4deg); }
  .hc-root .join-card h3 { font-family: var(--font-display); font-size: 1.2rem; color: var(--text); margin-bottom: 10px; }
  .hc-root .join-card p { font-size: 0.875rem; color: var(--text-muted); line-height: 1.65; }
  .hc-root .join-cta { text-align: center; }
  .hc-root .btn-rose-large {
  ...
  .hc-root .btn-rose-large:hover { background: var(--rose-deep); transform: translateY(-2px); box-shadow: 0 10px 28px rgba(168,85,112,0.32); }

  /* ── PRODUCT CARDS ── */
  .hc-root .carousel-wrap { position: relative; }
  .hc-root .carousel-track {
    display: flex; gap: 22px; overflow-x: auto;
    scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch;
    padding-bottom: 12px; cursor: grab;
  }
  .hc-root .carousel-track:active { cursor: grabbing; }
  .hc-root .carousel-track::-webkit-scrollbar { height: 4px; }
  .hc-root .carousel-track::-webkit-scrollbar-track { background: var(--rose-light); border-radius: 2px; }
  .hc-root .carousel-track::-webkit-scrollbar-thumb { background: var(--rose-mid); border-radius: 2px; }
  .hc-root .carousel-arrow {
  ...
  .hc-root .carousel-arrow:hover { background: var(--rose); color: white; border-color: var(--rose); }
  .hc-root .carousel-arrow.left { left: -20px; }
  .hc-root .carousel-arrow.right { right: -20px; }
  .hc-root .product-card {
  ...
  .hc-root .product-card:hover { transform: translateY(-8px); box-shadow: var(--shadow-hover); }
  .hc-root .product-img-wrap {
    height: 215px; position: relative; overflow: hidden;
    background: linear-gradient(135deg, var(--rose-light), var(--mauve-light));
  }
  .hc-root .product-emoji {
    position: absolute; inset: 0;
  ...
  .hc-root .product-card:hover .add-to-cart { bottom: 0; }
  .hc-root .product-info { padding: 15px 17px 18px; }
  .hc-root .product-region {
    font-size: 0.7rem; font-weight: 700; letter-spacing: 0.12em;
    text-transform: uppercase; color: var(--rose); margin-bottom: 4px;
  }
  .hc-root .product-name { font-family: var(--font-display); font-size: 1.05rem; color: var(--text); margin-bottom: 5px; }
  .hc-root .product-artist { font-size: 0.78rem; color: var(--text-muted); margin-bottom: 10px; }
  .hc-root .product-price { font-size: 1.05rem; font-weight: 700; color: var(--rose-deep); }
  .hc-root .product-price span { font-size: 0.78rem; font-weight: 400; color: var(--text-muted); text-decoration: line-through; margin-left: 6px; }

  .hc-root .pill-row { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 26px; }
  .hc-root .pill {
  ...
  .hc-root .pill:hover, .hc-root .pill.active { background: var(--rose); color: white; border-color: var(--rose); }

  .hc-root .paintings-section { background: var(--cream); }

  /* ── SPOTRI ── */
  .hc-root .spotri-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 18px; }
  .hc-root .spotri-card {
  ...
  .hc-root .spotri-card:nth-child(2) { grid-row: span 2; }
  .hc-root .spotri-card:hover { transform: scale(1.02); box-shadow: var(--shadow-hover); }
  .hc-root .spotri-img {
    display: flex; align-items: center; justify-content: center;
  ...
  .hc-root .spotri-card:nth-child(2) .spotri-img { min-height: 378px; }
  .hc-root .spotri-card:hover .spotri-img { transform: scale(1.05); }
  .hc-root .spotri-badge {
  ...
  .hc-root .spotri-card:hover .spotri-badge { opacity: 1; transform: translateY(0); }
  .hc-root .spotri-info { padding: 14px 16px; }
  .hc-root .spotri-info h4 { font-family: var(--font-display); font-size: 1rem; margin-bottom: 3px; }
  .hc-root .spotri-info p { font-size: 0.78rem; color: var(--text-muted); }
  .hc-root .section-link {
    display: inline-flex; align-items: center; gap: 8px;
    color: var(--rose-deep); font-weight: 600; font-size: 0.9rem;
    text-decoration: none; margin-top: 28px; transition: var(--transition);
  }
  .hc-root .section-link:hover { gap: 14px; color: var(--rose); }

  /* ── WOODEN ── */
  .hc-root .wood-section { background: #fdf6f0; }
  .hc-root .wood-split { display: grid; grid-template-columns: 1fr 1fr; gap: 56px; align-items: start; }
  .hc-root .wood-featured {
  ...
  .hc-root .wood-featured-emoji { font-size: 7.5rem; }
  .hc-root .wood-featured-badge {
    position: absolute; bottom: 22px; left: 22px; right: 22px;
    background: rgba(255,255,255,0.95); backdrop-filter: blur(8px);
    border-radius: 14px; padding: 18px 20px;
  }
  .hc-root .wood-featured-badge h3 { font-family: var(--font-display); font-size: 1.2rem; color: var(--text); }
  .hc-root .wood-featured-badge p { font-size: 0.82rem; color: var(--text-muted); margin: 4px 0 8px; }
  .hc-root .wood-featured-badge .price { font-size: 1.25rem; font-weight: 700; color: #8b5e3c; }
  .hc-root .wood-list { display: flex; flex-direction: column; gap: 14px; }
  .hc-root .wood-item {
  ...
  .hc-root .wood-item:hover { transform: translateX(6px); box-shadow: 0 6px 22px rgba(139,94,60,0.14); }
  .hc-root .wood-thumb {
    width: 68px; height: 68px; border-radius: 12px; flex-shrink: 0;
    background: linear-gradient(135deg, #e8d0b8, #c49a6c);
    display: flex; align-items: center; justify-content: center; font-size: 2rem;
  }
  .hc-root .wood-item-info h4 { font-family: var(--font-display); font-size: 0.95rem; margin-bottom: 3px; }
  .hc-root .wood-item-info p { font-size: 0.77rem; color: var(--text-muted); margin-bottom: 5px; }
  .hc-root .wood-price { font-size: 0.95rem; font-weight: 700; color: #8b5e3c; }
  .hc-root .wood-divider {
  ...
  /* ── STONE ── */
  .hc-root .stone-section { padding: 96px 60px; background: #2e2028; position: relative; overflow: hidden; }
  .hc-root .stone-section::before {
  ...
  .hc-root .stone-section .section-label { color: var(--rose-mid); }
  .hc-root .stone-section .section-title { color: white; }
  .hc-root .stone-section .btn-explore { border-color: rgba(255,255,255,0.22); color: rgba(255,255,255,0.75); }
  .hc-root .stone-section .btn-explore:hover { background: rgba(255,255,255,0.08); color: white; }
  .hc-root .stone-gallery { display: grid; grid-template-columns: repeat(4, 1fr); gap: 14px; }
  .hc-root .stone-card {
  ...
  .hc-root .stone-card:hover { transform: translateY(-6px); box-shadow: 0 14px 36px rgba(0,0,0,0.55); }
  .hc-root .stone-img {
  ...
  .hc-root .stone-card:hover .stone-img { transform: scale(1.05); }
  .hc-root .stone-info { padding: 15px; color: rgba(255,255,255,0.88); }
  .hc-root .stone-info h4 { font-family: var(--font-display); font-size: 0.95rem; margin-bottom: 3px; }
  .hc-root .stone-info p { font-size: 0.76rem; color: rgba(255,255,255,0.45); margin-bottom: 7px; }
  .hc-root .stone-price { font-size: 0.95rem; font-weight: 700; color: var(--rose-mid); }
  ...
  .hc-root .lightbox-emoji { font-size: 5.5rem; margin-bottom: 18px; display: block; }
  .hc-root .lightbox-close {
  ...
  .hc-root .lightbox-close:hover { background: rgba(255,255,255,0.18); color: white; }

  /* ── ARTISTS ── */
  .hc-root .artists-track { display: flex; gap: 22px; overflow-x: auto; padding-bottom: 12px; }
  .hc-root .artists-track::-webkit-scrollbar { height: 4px; }
  .hc-root .artists-track::-webkit-scrollbar-thumb { background: var(--rose-mid); border-radius: 2px; }
  .hc-root .artist-card {
  ...
  .hc-root .artist-card:hover { transform: translateY(-6px); box-shadow: var(--shadow-hover); }
  .hc-root .artist-avatar {
  ...
  .hc-root .artist-name { font-family: var(--font-display); font-size: 1.05rem; color: var(--text); margin-bottom: 3px; }
  .hc-root .artist-craft { font-size: 0.78rem; color: var(--text-muted); margin-bottom: 3px; }
  .hc-root .artist-location { font-size: 0.73rem; color: var(--rose); font-weight: 600; margin-bottom: 12px; }
  .hc-root .artist-stars { color: var(--amber); font-size: 0.82rem; margin-bottom: 15px; }
  .hc-root .btn-visit {
  ...
  .hc-root .btn-visit:hover { background: var(--rose); color: white; border-color: var(--rose); }

  /* ── TESTIMONIALS ── */
  .hc-root .testimonials-section { padding: 80px 60px; background: var(--rose-light); }
  .hc-root .testimonials-inner { max-width: 860px; margin: 0 auto; }
  .hc-root .testimonial-wrap { position: relative; min-height: 155px; }
  .hc-root .testimonial {
    position: absolute; inset: 0;
    display: flex; flex-direction: column; align-items: center; text-align: center;
    opacity: 0; transition: opacity 0.6s ease; padding: 0 32px;
  }
  .hc-root .testimonial.active { opacity: 1; position: relative; }
  .hc-root .testimonial-quote {
    font-family: var(--font-display); font-size: 1.2rem; font-style: italic;
    color: var(--text); line-height: 1.75; margin-bottom: 18px;
  }
  .hc-root .testimonial-author { font-weight: 600; color: var(--rose-deep); font-size: 0.88rem; }
  .hc-root .testimonial-role { font-size: 0.78rem; color: var(--text-muted); }
  .hc-root .trust-bar {
  ...
  .hc-root .trust-item { display: flex; align-items: center; gap: 10px; font-size: 0.85rem; font-weight: 600; color: var(--rose-deep); }
  .hc-root .trust-icon {
  ...
  /* ── FOOTER ── */
  .hc-root .footer { background: #2a1820; color: rgba(255,255,255,0.7); padding: 68px 60px 34px; }
  .hc-root .footer-grid {
  ...
  .hc-root .footer-brand { font-family: var(--font-display); color: white; font-size: 1.4rem; margin-bottom: 12px; }
  .hc-root .footer-desc { font-size: 0.86rem; line-height: 1.75; color: rgba(255,255,255,0.45); margin-bottom: 20px; }
  .hc-root .footer-socials { display: flex; gap: 10px; margin-bottom: 22px; }
  .hc-root .social-btn {
  ...
  .hc-root .social-btn:hover { background: var(--rose); color: white; }
  .hc-root .footer-col h4 { color: white; font-weight: 600; font-size: 0.88rem; margin-bottom: 17px; }
  .hc-root .footer-col ul { list-style: none; }
  .hc-root .footer-col ul li { margin-bottom: 10px; }
  .hc-root .footer-col ul li a { color: rgba(255,255,255,0.45); text-decoration: none; font-size: 0.83rem; transition: var(--transition); }
  .hc-root .footer-col ul li a:hover { color: rgba(255,255,255,0.9); }
  .hc-root .newsletter { display: flex; gap: 8px; margin-top: 10px; }
  .hc-root .newsletter input {
    flex: 1; padding: 10px 14px; border-radius: 10px;
    background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.1);
    color: white; font-family: var(--font-body); font-size: 0.83rem; outline: none; transition: var(--transition);
  }
  .hc-root .newsletter input::placeholder { color: rgba(255,255,255,0.3); }
  .hc-root .newsletter input:focus { border-color: var(--rose); }
  .hc-root .newsletter button {
    padding: 10px 15px; border-radius: 10px;
    background: var(--rose); color: white; border: none;
    font-family: var(--font-body); font-weight: 600; font-size: 0.83rem;
    cursor: pointer; transition: var(--transition);
  }
  .hc-root .newsletter button:hover { background: var(--rose-deep); }
  .hc-root .footer-bottom {
    max-width: 1280px; margin: 22px auto 0;
    display: flex; justify-content: space-between; align-items: center;
    font-size: 0.78rem; color: rgba(255,255,255,0.25);
  }

  @media (max-width: 1024px) { .hc-root
    .hc-root .nav-links { display: none; }
    .hc-root .join-grid { grid-template-columns: 1fr; }
    .hc-root .wood-split { grid-template-columns: 1fr; }
    .hc-root .stone-gallery { grid-template-columns: repeat(2, 1fr); }
    .hc-root .footer-grid { grid-template-columns: 1fr 1fr; }
    .hc-root .spotri-grid { grid-template-columns: 1fr 1fr; }
  }
  @media (max-width: 640px) { .hc-root
    .section, .join-section, .testimonials-section, .stone-section, .footer { padding-left: 22px; padding-right: 22px; }
    .hc-root .hero-slide { padding: 0 28px; }
    .hc-root .hero-dots { left: 28px; }
    .hc-root .navbar { padding: 0 20px; }
    .hc-root .nav-search { display: none; }
    .stone-gallery, .footer-grid { grid-template-columns: 1fr; }
    .hc-root .spotri-grid { grid-template-columns: 1fr; }
  }
`;
